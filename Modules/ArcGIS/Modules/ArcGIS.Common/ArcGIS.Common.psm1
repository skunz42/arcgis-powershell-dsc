...
function Get-ArcGISProductName
{
    ...
    }elseif($Name -ieq 'CoordinateSystemsData' -or $Name -ieq "ArcGIS Coordinate Systems Data"){
        $ProductName = 'ArcGIS Coordinate Systems Data'
...
function Get-ComponentCode
{
    ...
    $ProductCodes = @{
        ...
        Drone2Map = @{
            '2022.1' = '320243C7-F0D7-4694-85B4-2AFA245AF774'
        ...
        RealityStudio = @{
            '2023.1' = '599850D0-608E-42BE-AEBB-925F292FD0E3'
            '2024.1' = '7CDCFC88-7B73-4959-BC7E-559A2C7A0351'
            '2024.2' = '33450E32-CCE4-493D-BF57-B17308031CAF'
        }
        CoordinateSystemsData = @{
            '11.1' = 'D79BA24A-E228-43C4-8FDE-751C2E923C66'
            '11.2' = 'E54143C4-7364-4146-9241-E04027429033'
            '11.3' = 'F6ADF209-AC1B-4BA6-AED3-13DF20F6CFB8'
        }
        WebAdaptorIIS = @{
        ...
        ProReality = @{
            '3.1' = 'F3559669-E95E-401A-8F51-796ADED25209'
            '3.2' = '6B51AAD4-F167-4C73-A291-553D48C06619'
